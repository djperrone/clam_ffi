...
impl<'a> Handle<'a> {
    ...
    pub fn new(data_name: &str, cardinality: usize) -> Handle<'a> {
        ...
        //     h.clam_root = Self::build_root(data, cardinality);
        // }
        ...
        // h.build_root_with_self(cardinality);
        // Self::build_root_with_param(&mut h.clam_root.unwrap(), &h.dataset.unwrap(), cardinality);
        // if let Some(cluster) = &mut h.borrow_mut().clam_root {
